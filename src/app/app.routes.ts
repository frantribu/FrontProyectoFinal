...
export const routes: Routes = [
    ...
    {path:"vehiculos/:id", loadComponent:()=>import("./Pages/Vehiculo/detalle-vehiculo/detalle-vehiculo").then(c=>c.DetalleVehiculo)},

    {path:"vehiculos/nuevo/auto", loadComponent:()=>import("./Pages/Vehiculo/auto-form/auto-form").then(c=>c.AutoForm)},
    {path:"vehiculos/auto/:id/editar", loadComponent:()=>import("./Pages/Vehiculo/auto-form/auto-form").then(c=>c.AutoForm)},

    {path:"vehiculos/nuevo/moto", loadComponent:()=>import("./Pages/Vehiculo/moto-form/moto-form").then(c=>c.MotoFormComponent)},
